...
def characters():
    return jsonify({
        "原神": [k for k in CHARACTER_TAGS if k in [
            '雷电将军','甘雨','胡桃','刻晴','优菈','神里绫华','宵宫','心海','八重神子','纳西妲',
            '妮露','申鹤','云堇','久岐忍','柯莱','珐露珊','瑶瑶','迪希雅','琳妮特','芙宁娜',
            '娜维娅','千织','仆人','克洛琳德','希格雯','艾梅莉埃','玛拉妮','希诺宁','恰斯卡','茜特菈莉','玛薇卡']],
        "星铁": [k for k in CHARACTER_TAGS if k in [
            '三月七','姬子','布洛妮娅','希儿','克拉拉','停云','卡芙卡','银狼','符玄','藿藿',
            '黑天鹅','黄泉','知更鸟','流萤','云璃','飞霄','灵砂','阮梅','花火','镜流','翡翠','遐蝶','阿格莱雅','风堇','赛飞儿']],
        "崩坏3": [k for k in CHARACTER_TAGS if k in [
            '琪亚娜','芽衣','德丽莎','八重樱','卡莲','符华','丽塔','幽兰黛尔','希儿','萝莎莉娅',
            '莉莉娅','霞','艾琳','迷迭','识之律者','薪炎之律者','次生银翼','人律','终焉之律者','死生之律者','薇塔']],
    })
